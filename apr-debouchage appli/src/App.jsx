...
const SERVICES = [
  { id: "debouchage", label: "Débouchage", icon: "🔧", duration: 0.5, durationLabel: "À partir de 30 min", description: "Débouchage canalisations, WC, éviers — durée variable selon situation", color: "#e85d04" },
  { id: "citerne", label: "Nettoyage citerne", icon: "🛢️", duration: 8, durationLabel: "1 journée complète", description: "Nettoyage complet et vidange de citerne", color: "#1b4332" },
...
export default function App() {
  ...
  function reset() {
    ...
    setSubmitted(false); setCalStatus("idle");
  }
        ...
        <div style={S.card}>
          ...
          {calStatus === "error" && (
            <div style={{background:"#fff3e0", borderRadius:10, padding:"12px 16px", marginBottom:16, textAlign:"center", fontSize:13, color:"#e65100"}}>
              ⚠️ Le RDV est confirmé mais n'a pas pu être ajouté au calendrier.<br/>Vérifiez les autorisations Google.
            </div>
          )}
          ...
          <button style={{...S.nextBtn, width:"100%", marginTop:8}} onClick={reset}>
            + Nouveau rendez-vous
          </button>
        </div>
      </div>
        ...
        {step === 4 && (
          <div>
            ...
            <div style={S.navRow}>
              ...
              <button style={{...S.nextBtn, background:"#1b4332"}} onClick={handleSubmit}>
